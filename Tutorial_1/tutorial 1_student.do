...
cd "C:\Users\fx236\Downloads\Tutorial_1" //sets you directory: where Stata will look for files and save files 
...
replace var3 = 2 in 51/100 //replaces the last 50 obs of test with a 2 - !!!not good practice but useful here for the simulation
*Rename our variable:
rename var3 sex 
...
local example = `j'+1 //for an increase of +1, you could also write: local ++example
}
...
merge 1:1 id using occupation // merge 1:1 tells stata that each in dataset A will be uniquely matched to one row in dataset B
